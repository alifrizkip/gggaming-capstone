...
final class DeleteFavoriteInteractorTest: XCTestCase {
  private var cancellables: Set<AnyCancellable> = []

  func test_returnSuccessTrue() {
    // setup
    let repo = RepositoryMock<Int, Bool>(data: true)
    let useCase = Interactor<
      Int,
      Bool,
      RepositoryMock<Int, Bool>
    >(repository: repo)
  ...
  func test_returnSuccessFalse() {
    // setup
    let repo = RepositoryMock<Int, Bool>(data: false)
    let useCase = Interactor<
      Int,
      Bool,
      RepositoryMock<Int, Bool>
